...
try:
    ...
    image_name_file = config['SETTINGS']['image_name_file']
except KeyError:
    print("Error: 'folder_path' or 'image_name_file' not found in config.properties under [SETTINGS] section.")
    exit()
...
# Read the CSV file
try:
    df = pd.read_csv(image_name_file)
except FileNotFoundError:
    print(f"Error: The CSV file '{image_name_file}' was not found. Please ensure it's in the same directory as the script.")
    exit()
